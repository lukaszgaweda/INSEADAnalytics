...
To install a package in R click on the "Packages" lib
...
<hr>
1. Yes, I can install them from "packages menu" -> "install"
2.I like the "datasets" package as there is a lot of interesting and random sets (e.g InsectSprays)
3. Yes. I forked a deeplearing repository
4. Unfortunately I don't use either of them.
<hr>
...
<br>
tab
1. It's: "Q16_Name.of.the.Brand.rated"     
2. the average is produced by mean(ProjectData[,4])
3. The percentage share can be produced by: "r sum(ProjectData[,48]==1)/nrow(ProjectData)"
